			...
			$Player/Camera2D/CanvasLayer/PopupDialog.sendDialog([ # Envia o diálogo do marketer
					{
						'personagem': 'marketer',
						'falas': [
							'Aaaaaah meu jovem, como eu queria ter sua idade e com a visão que tenho hoje, entenderia muitas coisas mais rapidamente em minha vida.',
					...
					},
					{
						'personagem':'marketer',
						'falas':[
							'Meu segredo é tentar compreender quais são os problemas das pessoas e pensar em soluções, ajudando as pessoas a resolvê-los. Dessa maneira, quando ajudo a corrigir os problemas dessas pessoas, elas se tornam minhas clientes e então compram mais comida HAHAHA!!'
						]
					}
			])
				...
				$Player/Camera2D/CanvasLayer/PopupDialog.sendDialog([
					...
					},
					{
						...
						'falas': [
							...
							'Colorir uma faca não melhora sua funcionalidade. Portanto, pense nas características que tornam um machado melhor para cortar árvores.'
						]
					}
				])
	else:
			...
			if GlobalOptions.isPortuguese:
				...
				$Player/Camera2D/CanvasLayer/PopupDialog.sendDialog([
					...
					},
					{
						'personagem': 'jose',
						'falas': [
							'Preciso de um machado para cortar árvores.'
						]
					},
					{
						'personagem': 'blacksmith',
						'falas': [
							...
							'Agora entre em minha forja e escolha quais partes são as melhores para você.'
						]
					},
				])
		else:
